      ...
      <ScrollView style={styles.scrollView}>
        <View style={[styles.profileSection, { backgroundColor: colors.card }]}>
          <View style={styles.profileHeader}>
            ...
            >
              <Text style={[styles.profileInitials, { color: colors.card }]}>
                AJ
              </Text>
            </View>
        ...
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <Text style={[styles.sectionDescription, { color: colors.text }]}>
            Select your dietary preferences to get better restaurant
            recommendations
          </Text>
            ...
            {dietaryPreferences.map((preference) => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  preference.selected && [
                    styles.preferenceTagSelected,
                    { backgroundColor: colors.primary },
                  ],
                  {
                    backgroundColor: preference.selected
                      ? colors.primary
                      : colors.border,
                  },
                ]}
        ...
        <View style={[styles.section, { backgroundColor: colors.card }]}>
          ...
          <Text style={[styles.sectionDescription, { color: colors.text }]}>
            We&apos;ll help you avoid restaurants and dishes with these
            ingredients
          </Text>
          <View style={styles.preferencesContainer}>
            {allergies.map((allergy) => (
              <TouchableOpacity
                ...
                style={[
                  styles.allergyTag,
                  allergy.selected && [
                    styles.allergyTagSelected,
                    { backgroundColor: colors.danger },
                  ],
                  {
                    backgroundColor: allergy.selected
                      ? colors.danger
                      : colors.border,
                  },
                ]}
            ...
            {cuisinePreferences.map((cuisine) => (
              <TouchableOpacity
                ...
                style={[
                  styles.cuisineTag,
                  cuisine.selected && [
                    styles.cuisineTagSelected,
                    { backgroundColor: colors.success },
                  ],
                  {
                    backgroundColor: cuisine.selected
                      ? colors.success
                      : colors.border,
                  },
                ]}
